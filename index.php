  ...
  private function form() {
    ...
    class Login {
      ...
      constructor(){
        ...
        fetch(`<?php echo U::assetspath() ?>files.gallery@<?php echo Config::$version ?>/lang/${ lang_code }.json`)
...
class U {
  ...
  <html class="<?php echo $class; ?>" data-theme="contrast">
    ...
    <head>
      ...
      <link href="<?php echo U::assetspath(); ?>files.gallery@<?php echo Config::$version ?>/css/files.css" rel="stylesheet">
...
foreach (array_filter([
  ...
  'files.gallery@' . Config::$version . '/js/files.js'
...
if(U::get('action')){
  ...
  // check Files Gallery updates JSON file from jsdelivr.com repository
    ...
    $json = @json_decode(@file_get_contents('https://data.jsdelivr.com/v1/package/npm/files.gallery'), true);
  ...
  // attempt to update Files Gallery index.php to latest version via remote repository jsdelivr.com
    ...
    $get = @file_get_contents('https://cdn.jsdelivr.net/npm/files.gallery@' . $version . '/index.php');
